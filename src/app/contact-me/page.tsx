      ...
      <div className="text-center">
        ...
        {Object.keys(contacts).map((key) => (
          <p key={key} className="text-lg leading-8 text-gray-600 text-justify grid grid-cols-4 gap-2">
            ...
            <span><a target="_blank" href={contacts[key as keyof typeof contacts]}>{contacts[key as keyof typeof contacts]}</a></span>
          </p>
        ))}
        <p className="text-lg leading-8 text-gray-600 text-justify grid grid-cols-4 gap-2">
          <span className="capitalize col-start-2">Email: </span>
          <span><a target="_blank" href="mailto:aunnearzadon@outlook.com">aunnearzadon@outlook.com</a></span>
        </p>
